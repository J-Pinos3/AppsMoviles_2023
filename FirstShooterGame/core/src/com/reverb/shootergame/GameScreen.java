...
//todo KEEP ALONG WITH VIDEO 10 12:00
    //screen
...
//    private int backgroundOffset;
    ...
    private void prepareHUD() {
        ...
        hudRow2Y = hudRow1Y - font.getCapHeight();
    ...
    private void detectInput(float deltaTime) {
        ...
        if( available ){
            ...
            float sensivity = 1.5f;

            float acelMoveX = -acelX  * playerShip.movementSpeed * deltaTime;
            float acelMoveY = -(acelY - Gdx.input.getAccelerometerZ() )  * playerShip.movementSpeed * deltaTime;

            if (acelMoveX > 0) acelMoveX = Math.min(acelMoveX, WORLD_WIDTH - playerShip.boundingBox.x - playerShip.boundingBox.width);
            else acelMoveX = Math.max(acelMoveX, -playerShip.boundingBox.x);
